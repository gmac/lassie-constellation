...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Layer.subtitle_color'
        db.delete_column(u'scene_layer', 'subtitle_color')

        # Adding field 'Layer.voice'
        db.add_column(u'scene_layer', 'voice',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['interaction.Voice'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Layer.subtitle_color'
        db.add_column(u'scene_layer', 'subtitle_color',
                      self.gf('django.db.models.fields.CharField')(default='#ffffff', max_length=10),
                      keep_default=False)

        # Deleting field 'Layer.voice'
        db.delete_column(u'scene_layer', 'voice_id')
